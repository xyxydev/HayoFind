                  ...
                  <div class="col-lg-8">
                    <div class="contact-box p-4">
                      ...
                      <?php
                          ...
                          $email = $passRow['email'];
                          $phoneNumber = $passRow['phoneNumber'];
                          
                      ?>
                      <form action="function/_manageContactUs.php" method="POST">
                        <div class="row">
                          <div class="col-lg-6">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="phone" name="phone" aria-describedby="basic-addon" placeholder="Enter Your Phone Number" required pattern="[0-9]{10}" value="<?php echo $phoneNumber ?>">
                                </div>
                            </div>
                          </div>
                          <div class="col-lg-6">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" id="messagebd">
              <table class="table-striped table-bordered col-md-12 text-center">
                ...
                <tbody>
                <?php 
                    $sql = "SELECT * FROM `contact_reply` WHERE `user_ID`='$user_ID'"; 
