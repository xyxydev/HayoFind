...
<div class="container-fluid" >
    <a class="mb-3 button" href="index.php" id="backtohome" style="margin-left: 210px;">Back to Home</a>
	<div class="row">
		<div class="card col-lg-12" style="border: none !important;">
			<div class="card-body">
				<table class="table-striped col-md-9 text-center"  style="margin-left: 210px;">
