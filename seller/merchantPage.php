...
<html lang="en">
<head>
    <link rel="stylesheet" href="seller css/merchantPage.css">
...
<body>
    <div class="navbarBox">
        <div class="logoName">
            <img class="logo-img" src="seller images/logo.png" alt="registerLogo">
        </div>
    ...
    <div class="home-btns">
        ...
        <a href="manageOrders.php" class="cust-btn">Manage orders</a>
    </div>
