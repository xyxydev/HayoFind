...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="seller css/sellerHeader.css">
    <!-- ICON -->
...
<div class="navbarBox">
        ...
        <ul class="ul-nav">
            ...
            <li><a class="myproducts-anc" href="merchantProducts.php">My Products</a></li>
                ...
                <?php if(isset($myorders) && $myorders == true): ?>
                    <li><a class="myorders-anc" href="manageOrders.php" style="border-bottom: 1px solid #52734D;border-radius: 5px;padding-left: 30px;
                padding-right: 30px;padding-top: 18px;  padding-bottom: 18px;background-color: #52734D;">My Orders</a></li>
                <?php else: ?>
